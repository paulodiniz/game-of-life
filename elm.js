...
var $author$project$Main$initialCells = function () {
	...
	var initializeCols = function (_v0) {
		return $elm$core$Array$toList(
			A2($elm$core$Array$initialize, $author$project$Main$numCols, initCell));
	};
	return $elm$core$Array$toList(
...
var $author$project$Main$seedLifeInCell = F2(
	function (_v0, cells) {
		var rowIndex = _v0.a;
		var colIndex = _v0.b;
		var column = $elm$core$Array$fromList(
			A2(
		...
		var newColumn = $elm$core$Array$toList(
			A3($elm$core$Array$set, colIndex, $author$project$Main$Alive, column));
		return $elm$core$Array$toList(
			A3(
				$elm$core$Array$set,
				rowIndex,
...
var $author$project$Main$seedLife = F2(
	function (_v0, indexes) {
		var cells = _v0.cells;
		return A3($elm$core$List$foldl, $author$project$Main$seedLifeInCell, cells, indexes);
	});
...
var $author$project$Main$getNeighbours = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	var possible = _List_fromArray(
		[
	...
	return A2(
		...
		function (point) {
			return (point.b >= 0) && (_Utils_cmp(point.b, $author$project$Main$numCols) < 0);
		},
		A2(
			$elm$core$List$filter,
			function (point) {
				return (point.a >= 0) && (_Utils_cmp(point.a, $author$project$Main$numRows) < 0);
			},
			possible));
};
var $author$project$Main$isCellAlive = F2(
	function (model, point) {
		...
		var value = A2(
			...
			A2(
				$elm$core$Array$get,
				y,
				$elm$core$Array$fromList(column)));
		if (value.$ === 'Dead') {
			return false;
		} else {
			return true;
...
var $author$project$Main$aliveNeighbours = F2(
	function (model, point) {
		var neighbours = $author$project$Main$getNeighbours(point);
		return A2(
			$elm$core$List$filter,
			function (neighbour) {
				return A2($author$project$Main$isCellAlive, model, neighbour);
			},
			neighbours);
	});
			...
			case 'SeedLife':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							cells: A2($author$project$Main$seedLife, model, indexes)
						}),
...
var $author$project$CanvasEvents$PositionData = F4(
	function (client, offset, body, documentElement) {
		return {body: body, client: client, documentElement: documentElement, offset: offset};
	});
...
var $author$project$CanvasEvents$toTuple = F2(
	function (x, y) {
		return A3(
			$elm$json$Json$Decode$map2,
			$elm$core$Tuple$pair,
			A2($elm$json$Json$Decode$at, x, $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$at, y, $elm$json$Json$Decode$float));
	});
var $author$project$CanvasEvents$positionDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$CanvasEvents$PositionData,
	A2(
		$author$project$CanvasEvents$toTuple,
		_List_fromArray(
			['clientX']),
		_List_fromArray(
			['clientY'])),
	...
	A2(
		$author$project$CanvasEvents$toTuple,
		_List_fromArray(
			['view', 'document', 'body', 'scrollLeft']),
		_List_fromArray(
			['view', 'document', 'body', 'scrollTop'])),
	A2(
		$author$project$CanvasEvents$toTuple,
		_List_fromArray(
			['view', 'document', 'documentElement', 'scrollLeft']),
		_List_fromArray(
			['view', 'document', 'documentElement', 'scrollTop'])));
var $author$project$CanvasEvents$Point = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var $author$project$CanvasEvents$positionInCanvas = function (_v0) {
	var client = _v0.client;
	var offset = _v0.offset;
	var body = _v0.body;
	var documentElement = _v0.documentElement;
	var _v1 = offset;
	var ox = _v1.a;
	var oy = _v1.b;
	var _v2 = documentElement;
	var dx = _v2.a;
	var dy = _v2.b;
	var _v3 = client;
	var cx = _v3.a;
	...
	var bx = _v4.a;
	var by = _v4.b;
	return A2($author$project$CanvasEvents$Point, ((cx + bx) + dx) - ox, ((cy + by) + dy) - oy);
};
var $author$project$CanvasEvents$onClick = function (message) {
	return A2(
		$elm$html$Html$Events$on,
		'click',
		A2(
			$elm$json$Json$Decode$map,
			A2($elm$core$Basics$composeR, $author$project$CanvasEvents$positionInCanvas, message),
			$author$project$CanvasEvents$positionDecoder));
};
